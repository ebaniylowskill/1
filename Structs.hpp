...
public:
	...
	FloatVector3D GetPosition() const {
		return FloatVector3D(matrix[0][3], matrix[1][3], matrix[2][3]);
	}

	FloatVector3D GetPosition2() const {
		return FloatVector3D(matrix[0][3], matrix[1][3], matrix[2][3]);
	}
};
...
public:
	...
	FloatVector3D Transform(const FloatVector3D vector) const {
		FloatVector3D transformed;
